...
def plot_simulation(
    ...
    """Plot every batch member in an MPPI mass-spring-damper simulation."""
    ...
    axes[1].set_title("MPPI control forces")
    ...
    figure.suptitle("MPPI mass-spring-damper simulation")
...
def render_animation(
    ...
    axis.set_title("MPPI mass-spring-damper simulation")
    ...
    writer = FFMpegWriter(fps=fps, metadata={"title": "MPPI mass-spring-damper simulation"})
