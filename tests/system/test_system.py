...
class TestSystem:
    ...
    def test_system_initialization(self):
        ...
        assert np.allclose(self.system.observation, np.zeros(self.observation_dim))
    ...
    def test_control_system_initialization(self):
        ...
        assert np.allclose(self.control_system.observation, np.zeros(self.observation_dim))
        assert np.allclose(self.control_system.control, np.zeros(self.control_dim))
