...
MODULE = "examples.system.mass_spring_damper"
...
class TestMassSpringDamperExample:
    ...
    def test_saves_multibatch_plot_and_animation(self, tmp_path: Path) -> None:
        ...
        plot_path = tmp_path / "mass_spring_damper_plot.png"
        animation_path = tmp_path / "mass_spring_damper_animation.mp4"
